...
@Component
public class AskForMoreInfoDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        String subject = "[GetAGuide] We need more information on your complaint" + supportIssue.getClientId();
        Context context = new Context(Locale.getDefault());
        context.setVariable("supportIssue", supportIssue);
        String content = templateEngine.process("supportIssueProcess/AskForMoreInfoEmail", context);
